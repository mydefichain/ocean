...
#Check for debian 10/11 or Ubuntu 20.04/22.04:
lsb_release -a
echo "Check OS...Debian 10/11 or Ubuntu 20.04/22.04 needed"
sleep 3
#Update...
...
apt install -qqy sudo nano mc ufw curl ftp htop python3 python3-pip pwgen apache2 php libapache2-mod-php docker docker-compose
...
#Latest Snapshot
LATEST=$(curl https://snapshot-de.mydefichain.com/latest.txt)
...
#// Scripte kopieren:
cd ~/whale/
wget https://raw.githubusercontent.com/mydefichain/ocean/main/docker-compose.yml

cd ~/script/
wget https://mydeficha.in/tools/script/restart_defid.sh
wget https://raw.githubusercontent.com/mydefichain/mainnet/main/api/api_collector.py
wget https://raw.githubusercontent.com/mydefichain/mainnet/main/api/api_calls.txt
wget https://raw.githubusercontent.com/mydefichain/mainnet/main/api/subfunctions.py
